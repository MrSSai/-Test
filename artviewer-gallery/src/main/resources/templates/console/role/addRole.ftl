...
<!--<head th:replae="frcagments/common_header :: common_header(~{::title})"><head>-->
<head>
        ...
        <fieldset>
            ...
            <div class="form-actions">
                <div class="row" align="center">
                    <div class="col-md-12">
                        <button class="btn btn-primary" onclick="location.href='/console/role/roleList.ftl'">返回</button>
        ...
        $.ajax({
            ...
            success : function(data) {
                layer.msg("成功", {shift: -1, time: 1000}, function(){
                    location.href = "/console/role/roleList.ftl";
                });
            }
        });
    }
